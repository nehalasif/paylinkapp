            ...
            <main className="flex-grow flex items-center justify-center p-4 pt-10 md:p-6 md:pt-12 relative z-10">
                <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="space-y-6 animate-fade-in-up">
                        <div className="w-16 h-16 bg-white rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.1)]  flex items-center justify-center text-3xl font-extrabold select-none">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="bg-white/40 backdrop-blur-3xl p-5 rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.1)] border border-white/50 flex flex-col items-start gap-2 transition-shadow">
                        ...
                        <div className="bg-white/40 backdrop-blur-md border border-white/50 rounded-xl p-3 flex items-center gap-3 shadow-[0_0_20px_rgba(0,0,0,0.1)] ">
                            ...
                            <p className="text-slate-700 italic text-md pl-8 text-center">"Paying bills has never been this easy and secure"</p>
                        </div>
                    </div>

                    {/* ======================= RIGHT SIDE ======================= */}
                    <div className="bg-white/50 backdrop-blur-3xl rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.1)] p-6 md:p-8 border border-white/50 h-fit">
                        <div className="mb-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="bg-gray-100 rounded-lg border border-white/50 focus-within:border-btnBlue focus-within:bg-white transition-all">
                                    <Textbox
                                        ...
                                        value={kuickpayID}
                                        // ============================================
                                        // ONLY NUMERIC LOGIC ADDED HERE:
                                        onChange={(e) => {
                                            const val = e.target.value;
                                            // Regular Expression: sirf digits (0-9) allow karega
                                            if (/^\d*$/.test(val)) {
                                                setKuickpayID(val);
                                            }
                                        }}
                                        // Mobile keyboard ke liye number pad open karega
                                        inputMode="numeric"
                                        // ============================================
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className={`w-full bg-[#287DCE] text-white font-semibold py-3 px-6 hover:scale-105 rounded-lg shadow-md transition-all flex items-center justify-center gap-2 mt-2 ${
