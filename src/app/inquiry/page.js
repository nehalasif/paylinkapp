...
// --- NEW COMPONENT FOR COPY LOGIC ---
const CopyAction = ({ textToCopy }) => {
    ...
    return (
        <div className="relative group inline-flex flex-col items-center ml-2 align-middle">
            {/* Clickable Image */}
            <button
                onClick={handleCopy}
                className="focus:outline-none transition-transform duration-200 ease-in-out hover:scale-125"
            >
                <Image src={copyicon} alt="Copy" className="w-5 h-5 cursor-pointer" />
            </button>

            {/* Tooltip Text (Shows below the icon) */}
            <div className="absolute top-full mt-1 px-2 py-1 bg-black text-white text-[10px] rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
                {copied ? 'Copied!' : 'Copy'}
            </div>
        </div>
    );
    ...
    const renderBankAccordionItem = (bank) => (
        <div key={bank.id} className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden transition-all duration-300">
            <button
                ...
                className={`w-full flex justify-between items-center p-4 text-left text-lg transition-colors duration-200 ${activeAccordion === bank.id
...
const PaymentInitilization = () => {
    ...
    return (
        <div className="p-1 flex flex-col min-h-screen relative z-10" >
            ...
            <main className="flex-grow ">
               <div className="mb-6">
                                <label className="block  text-center  font-outfit text-5xl p-2 text-slate-700">Payments</label>
                                <p className="text-gray-500 text-center text-sm">Your Trusted Payment Partner.</p>
                            </div>
                {inquiryStatus && voucherData && institutionData ? (
                    <div className="flex flex-col md:flex-row gap-6 p-6 md:p-6 lg:p-4 relative">
                        <div className="w-full md:w-6/12 order-2 md:order-1">
                            <div className="mb-6">
                                <label className="block  pl-8   text-2xl p-2 text-slate-700">Select Payment Methods</label>
                                <p className="text-gray-500 pl-8 text-sm">Choose your preferred payment option below</p>
                            </div>

                            <div className="space-y-4">

                                <div className="bg-white rounded-2xl  shadow-[0_0_10px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                                    <div
                                    ...
                                    <div className={`overflow-hidden transition-all duration-500 ease-in-out ${expanded === 0 ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                        <div className="p-5 pt-0">
                                            ...
                                            {/* --- UPDATED BUTTON (Pay with Card) --- */}
                                            <button
                                                onClick={CardPayNowOnClick}
                                                className="w-full bg-btnBlue    text-white  font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 mb-3 shadow-sm transition-all duration-200 hover:scale-105"
                                            >
                                            ...
                                            <button
                                                onClick={CardPayNowOnClick}
                                                className="w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-800 font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors  hover:scale-105"
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    className="w-full bg-btnBlue   text-white  font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 mt-4 shadow-sm transition-all duration-200 hover:scale-105"
>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    Save to Gallery
                                ...
                                {/* 3. Internet Banking - MODIFIED SECTION */}
                                <div className="bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                                    <div
                                        className="cursor-pointer p-5 flex justify-between items-center w-full hover:bg-gray-50 transition-colors"
                                    ...
                                    <div className={`overflow-hidden transition-all duration-500 ease-in-out ${expanded === 2 ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                        <div className="p-6 pt-0">
                                            <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                                ...
                                                <ol className="list-decimal text-gray-600 pl-4 space-y-2 text-sm">
                                                    ...
                                                    <li className="flex flex-wrap items-center gap-1">
                                                        ...
                                                        {/* --- UPDATED COPY BUTTON IS HERE --- */}
                                                        <CopyAction textToCopy={data.kuickpayID} />
                                                        {/* ----------------------------------- */}
                                                    </li>
                                            ...
                                            <div className="mt-4">
                                                <button onClick={() => setIsHowToPayModalOpen(true)} className="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 py-2 hover:scale-105 rounded-lg text-sm font-medium transition-colors">
                                                    See How to Pay
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div className="w-full md:w-5/12 order-1  md:order-2 flex justify-center">
                            <div className="px-4 mt-10 py-3 xsize:w-full sm:w-full lg:w-12/12">
                                <div className='px-6 py-6 bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-2xl border border-gray-100'>
